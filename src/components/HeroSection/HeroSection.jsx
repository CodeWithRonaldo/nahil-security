  ...
  const slides = [
    {
      ...
      description:
        "Providing comprehensive security personnel solutions with highly trained officers for all your protection needs.",
      features: [
    ...
    },
    {
      ...
      description:
        "End-to-end secure logistics solutions ensuring safe transportation and delivery of your valuable items.",
      features: [
        "Dispatch Arrangement",
        "Express & Secured Delivery",
        "Consignments/Cargo Handling",
      ],
      imageUrl: CargoImg,
    ...
    },
    {
      ...
      description:
        "Specialized security for diamonds, gold, and jewelry with state-of-the-art vault facilities and handling protocols.",
      features: [
        "Diamond, Gold & Jewelry Security",
