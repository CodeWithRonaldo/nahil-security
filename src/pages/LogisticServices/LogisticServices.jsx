...
const logisticsServices = [
  {
    ...
    description: "Comprehensive third-party logistics solutions to streamline your supply chain operations.",
    image: thirdPartyImage
  },
  {
    id: 2,
    title: "Consignments/Cargo Handling",
    description: "Professional handling of consignments and cargo with maximum security and efficiency.",
  ...
  },
  {
    ...
    description: "High-security transportation solutions for valuable and sensitive deliveries.",
    image: securedDeliveryImage
  },
  {
    id: 5,
    title: "Commodities",
    description: "Specialized handling and transportation of various commodities across multiple industries.",
  ...
  },
  {
    id: 7,
    title: "Fine Arts",
    description: "Specialized transportation and handling of fine art and cultural artifacts.",
    image: fineArtsImage
  },
  {
    id: 8,
    title: "Jet Service",
    description: "Premium air transport solutions for urgent and high-value shipments.",
    image: jetServiceImage
  },
  {
    id: 9,
    title: "Trade Show Packages",
    description: "Comprehensive logistics services for trade show exhibits and materials.",
      ...
      <section className={styles.heroSection}>
        <div className={styles.heroContent}>
          ...
          >
            ...
            <p>We deliver comprehensive logistics solutions to meet the unique requirements of businesses and individuals, ensuring efficient movement of goods across the globe.</p>
